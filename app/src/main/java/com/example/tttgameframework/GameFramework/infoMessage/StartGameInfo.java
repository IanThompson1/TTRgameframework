...
public class StartGameInfo extends GameInfo {
    ...
    // an array, in order of the names of all the com.example.tttgameframework.tickettoride.players playing the game
     ...
     * 		an array containing the names of all the com.example.tttgameframework.tickettoride.players that are playing
