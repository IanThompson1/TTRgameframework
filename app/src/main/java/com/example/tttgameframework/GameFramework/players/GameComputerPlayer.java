...
public abstract class GameComputerPlayer implements GamePlayer, Tickable {
        ...
        public void run() {
            ...
            if (data instanceof GameInfo) { // ignore non GameInfo objects
                ...
                if (game == null) {
                    ...
                    // CASE 2: we don't know the names of a the com.example.tttgameframework.tickettoride.players; the only thing we're
                    // looking for is a StartGameInfo object; ignore everything else
                    if (myInfo instanceof StartGameInfo) {
                        // set our instance variable with the com.example.tttgameframework.tickettoride.players' names
    ...
    /** tells whether this player supports a GUI. Some computer com.example.tttgameframework.tickettoride.players may be
