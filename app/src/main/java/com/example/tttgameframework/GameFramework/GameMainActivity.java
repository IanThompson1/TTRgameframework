...
public abstract class GameMainActivity extends Activity implements
    ...
    // an array containing references to all the com.example.tttgameframework.tickettoride.players that are playing the game
...
//		}
    ...
    /**
     * Creates the game and com.example.tttgameframework.tickettoride.players, and starts the game.
     *
     * @param config
    ...
    private final String launchGame(GameConfig config, GameState gameState) {
        ...
        //////////////////////////////////////
        // create the com.example.tttgameframework.tickettoride.players
        //////////////////////////////////////
        int requiresGuiCount = 0; // the number of com.example.tttgameframework.tickettoride.players that require a GUI
        guiPlayer = null; // the player that will be our GUI player
        players = new GamePlayer[config.getNumPlayers()]; // the array to contains our com.example.tttgameframework.tickettoride.players
    ...
    public void onClick(View button) {
        ...
        // Delete Player Button
            ...
            // Search the existing com.example.tttgameframework.tickettoride.players to find out which delete button got
            // clicked
    ...
    private void removePlayer(TableRow row) {
        // first, make sure that we won't exceed the min number of com.example.tttgameframework.tickettoride.players
    ...
    private TableRow addPlayer() {
        // first, make sure that we won't exceed the max number of com.example.tttgameframework.tickettoride.players
    ...
    public GameConfig scrapeData() {
        ...
        // First make a copy of the original config without the com.example.tttgameframework.tickettoride.players
